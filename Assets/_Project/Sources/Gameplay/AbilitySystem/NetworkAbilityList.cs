...
//    {
//        private readonly List<BaseAbility> _value = new List<BaseAbility>(8);

//        public IList<BaseAbility> Value => _value;

//        public NetworkAbilityList(IEnumerable<BaseAbility> values = default,
